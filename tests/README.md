...
- `rack_campaign_smoke.sh`: disposable Git fixture campaign with two local commits, no-op/path-policy rejection, JSON status/events, and restart-without-duplicate-commit; exits 2 when rootless Podman or the executor image is missing
