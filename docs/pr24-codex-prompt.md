...
First read AGENTS.md and its mandatory documents, then the PR24 contract and review once. The reviewed main was e197079c26cd0d0cb0fb2a85ba5a2af605c244b8; PR32 is already incorporated. Fetch current refs, check ancestry and local worktree status, and incorporate current origin/main into the PR24 work using an ordinary merge in an isolated clean worktree. Preserve PR24's documentation and all unrelated/uncommitted work. Do not force-push, reset a live checkout, revive old PR stacks, or merge PR24 into main.
